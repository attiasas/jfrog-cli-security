...
func GitAuditCmd(c *components.Context) error {
	...
	gitAuditCmd.SetScanResultsRepository(c.GetStringFlagValue(flags.ScanResultsRepository))
	gitAuditCmd.SetScanResultsOutputDir(c.GetStringFlagValue(flags.OutputDir))
