...
var commandFlags = map[string][]string{
	...
	Audit: {
		url, xrayUrl, user, password, accessToken, ServerId, InsecureTls, Project, Watches, ScanRepoPath, Licenses, OutputFormat, ExcludeTestDeps,
...
var flagsMap = map[string]components.Flag{
	...
	NewSca:        components.NewBoolFlag(NewSca, "[BETA] Use new SCA engine to run the SCA scan."),
